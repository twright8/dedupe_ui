...
export const TERMS = [
  ...
  {
    key: "candidateFloor",
    term: "lowest score kept",
    plural: "lowest scores kept",
...
export const RETIRED = [
  ...
  { bad: "withheld group", use: "cluster for review" },
  { bad: "withheld groups", use: "clusters for review" },
  { bad: "withheld cluster", use: "cluster for review" },
  { bad: "withheld clusters", use: "clusters for review" },
  ...
  { bad: "candidate threshold", use: "lowest score kept" },
  { bad: "candidate floor", use: "lowest score kept" },
