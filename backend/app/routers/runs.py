...
_FILE_DESCRIPTIONS = {
    ...
    "pairs_index.parquet": "The pairs list, ready to page over. Rebuilt whenever the pairs change",
    "clusters_index.parquet": "One row per cluster, with what the review queue shows",
    "entities_index.parquet": "One row per entity, with what the Entities list shows",
    "exact_groups_index.parquet": "One row per exact group, with what the screen shows",
    "pairs_counts.json": "The chips above the pairs list, and what they were counted from",
